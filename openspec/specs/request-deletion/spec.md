# Spec: Eliminación de Peticiones

## Purpose

Permitir a los usuarios gestionar su espacio de trabajo eliminando peticiones y carpetas que ya no son necesarias, asegurando que se liberen recursos (pestañas y selección) y se pida confirmación para evitar pérdidas accidentales.

## Requirements

### Requirement: Eliminar Archivo de Petición
Los usuarios deben poder eliminar un archivo `.j5request`, y dicha eliminación debe activar un diálogo de confirmación.

#### Scenario: Usuario elimina un archivo de petición
...
#### Scenario: Usuario elimina una carpeta
...
### Requirement: Cancelar Eliminación
