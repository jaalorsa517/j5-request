# Spec: Multi-Distro Linux Packaging

## Purpose
Garantizar la máxima compatibilidad nativa en el ecosistema Linux mediante la generación de paquetes para las principales familias de distribuciones (Debian, RedHat, Arch).
