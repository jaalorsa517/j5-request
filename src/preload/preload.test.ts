...
describe('Preload Script', () => {
    beforeEach(() => {
        ...
        // We need to use require because import() is async and might be cached differently or harder to reset?
        // Actually, with vi.resetModules(), dynamic import should re-evaluate.
