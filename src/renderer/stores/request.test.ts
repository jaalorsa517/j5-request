...
describe('Request Store', () => {
    ...
    it('should initialize default tab if empty', () => {
        const store = useRequestStore();
        store.tabs = [];
        // Pinia store setup already called it once. Let's call it manually if we can,
        // or just rely on the fact that it was called on store creation.
        // Actually, initDefaultTab is internal but exported in return.
